...
SELECT Person.PersonName , Person.PersonID , Person.Salary , Dept.DepartmentName
FROM Person JOIN Dept
ON Person.DepartmentID = Dept.DepartmentID
...
SELECT COUNT(Person.PersonID) AS COUNT_PERSON
FROM Person JOIN Dept
ON Person.DepartmentID = Dept.DepartmentID
...
SELECT MAX(Person.Salary) AS MAX_SALARY , 
MIN(Person.Salary) AS MIN_SALARY ,
SUM(Person.Salary) AS SUM_SALARY , 
...
SELECT SUM(Person.Salary) FROM Person JOIN Dept
ON Person.DepartmentID = Dept.DepartmentID
