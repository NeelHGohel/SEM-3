CREATE DATABASE NEEL_GOHEL_241;
...
CREATE TABLE BORROW(
	...
	BNAME VARCHAR(50),
	AMOUNT DECIMAL(8,2),
	EXTRA_LOANAMOUNT DECIMAL(8,2)
);

SELECT * FROM BORROW;

INSERT INTO BORROW VALUES(201,'ANIL','VRCE',1000,1100);
INSERT INTO BORROW VALUES(206,'MEHUL','AJNI',5000,5500);
INSERT INTO BORROW VALUES(311,'SUNIL','DHARAMPETH',3000,3300);
INSERT INTO BORROW VALUES(321,'MADHURI','ANDHERI',2000,2200);
INSERT INTO BORROW VALUES(375,'PRAMOD','VIRAR',8000,8800);
INSERT INTO BORROW VALUES(481,'KRANTI','NEHRU PLACE',3000,3300);